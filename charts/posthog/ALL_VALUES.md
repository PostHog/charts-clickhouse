...
![Version: 27.2.3](https://img.shields.io/badge/Version-27.2.3-informational?style=flat-square) ![AppVersion: 1.40.1](https://img.shields.io/badge/AppVersion-1.40.1-informational?style=flat-square)
...
| image.default | string | `":release-1.40.1"` | PostHog default image. Do not overwrite, use `image.sha` or `image.tag` instead. |
