...
|-----|------|---------|-------------|
| image | object | `{"default":":release-1.31.0","pullPolicy":"IfNotPresent","repository":"posthog/posthog","sha":null,"tag":null}` |  This is a YAML-formatted file. Declare variables to be passed into your templates. |
...
| image.tag | string | `nil` | Posthog image tag, e.g. release-1.31.0 |
| image.default | string | `":release-1.31.0"` | Default image or tag, e.g. :release-1.31.0 |
