...
![Version: 24.0.2](https://img.shields.io/badge/Version-24.0.2-informational?style=flat-square) ![AppVersion: 1.37.0](https://img.shields.io/badge/AppVersion-1.37.0-informational?style=flat-square)
...
| image.default | string | `":release-1.37.0"` | PostHog default image. Do not overwrite, use `image.sha` or `image.tag` instead. |
