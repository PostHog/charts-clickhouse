...
![Version: 28.0.0](https://img.shields.io/badge/Version-28.0.0-informational?style=flat-square) ![AppVersion: 1.41.0](https://img.shields.io/badge/AppVersion-1.41.0-informational?style=flat-square)
...
| image.default | string | `":release-1.41.0"` | PostHog default image. Do not overwrite, use `image.sha` or `image.tag` instead. |
