...
![Version: 30.31.0](https://img.shields.io/badge/Version-30.31.0-informational?style=flat-square) ![AppVersion: 1.43.0](https://img.shields.io/badge/AppVersion-1.43.0-informational?style=flat-square)
...
| clickhouse.image.tag | string | `"23.8.4.69"` | ClickHouse image tag. Note: PostHog does not support all versions of ClickHouse. Please override the default only if you know what you are doing. |
...
| clickhouse.client.image.tag | string | `"23.8.4.69"` | ClickHouse image tag. Note: PostHog does not support all versions of ClickHouse. Please override the default only if you know what you are doing. |
