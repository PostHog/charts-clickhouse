...
# Setting a value for the tag here to 23.8.4.69-alpine
...
def test_clickhouse_pod_image(kube):
    ...
    assert pod_spec.containers[0].image == "clickhouse/clickhouse-server:23.8.4.69-alpine"
